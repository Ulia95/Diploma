...
### 4 Отправка формы с коротким номером карты
...
### 9 Отправка формы с прошедшим годом
...
### 11 Отправка формы с пустым полем "Год"
...
### 12 Отправка формы с введенными цифрами в поле "Владелец" 
...
### 14 Отправка формы с некорректным "CVC/CVV"
...
### 16 Отправка формы с разрешенной картой
...
### 17 Отправка формы с неразрешенной картой
...
### 18 Отправка формы с ведёнными нулями в поле "Номер карты"
...
### 20 Отправка формы с пустым полем "Номер карты"
...
### 21 Отправка формы с нулевым месяцем
...
### 22 Отправка формы с тринадцатым месяцем
...
### 23 Отправка формы с пустым полем "Месяц"
...
### 24 Отправка формы с прошедшим годом
...
### 25 Отправка формы с введёнными нулями в поле "Год"
...
### 26 Отправка формы с пустым полем "Год"
...
### 27 Отправка формы с введенными цифрами в поле "Владелец"
...
### 28 Отправка формы с пустым полем "Владелец"
...
### 29 Отправка формы с некорректным "CVC/CVV"
...
###  30 Отправка формы с пустым полем "CVC/CVV"
